...
var (
	...
	AnonymousUsersColumns = []*schema.Column{
		...
		{Name: "last_activity_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
	}
	...
	ConfigHistoriesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUUID},
		{Name: "old_config_data", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"mysql": "json", "postgres": "jsonb"}},
		{Name: "new_config_data", Type: field.TypeJSON, SchemaType: map[string]string{"mysql": "json", "postgres": "jsonb"}},
	...
	ExportRecordsColumns = []*schema.Column{
		...
		{Name: "export_settings", Type: field.TypeJSON, SchemaType: map[string]string{"mysql": "json", "postgres": "jsonb"}},
		{Name: "selected_nodes", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"mysql": "json", "postgres": "jsonb"}},
		...
		{Name: "ip_address", Type: field.TypeString, Nullable: true},
		{Name: "user_agent", Type: field.TypeString, Nullable: true},
		{Name: "started_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "timestamp", "postgres": "timestamptz"}},
		{Name: "completed_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "timestamp", "postgres": "timestamptz"}},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "timestamp", "postgres": "timestamptz"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "language", Type: field.TypeString, Nullable: true},
		{Name: "is_active", Type: field.TypeBool},
		{Name: "last_login_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "timestamp", "postgres": "timestamptz"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
	}
	...
	UserAuthsColumns = []*schema.Column{
		...
		{Name: "provider_data", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"mysql": "json", "postgres": "jsonb"}},
		{Name: "access_token", Type: field.TypeString, Nullable: true},
		{Name: "refresh_token", Type: field.TypeString, Nullable: true},
		{Name: "token_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "timestamp", "postgres": "timestamptz"}},
		{Name: "is_primary", Type: field.TypeBool},
		{Name: "is_enabled", Type: field.TypeBool},
		{Name: "last_used_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "timestamp", "postgres": "timestamptz"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"mysql": "timestamp DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP", "postgres": "timestamptz DEFAULT CURRENT_TIMESTAMP"}},
	...
	UserConfigsColumns = []*schema.Column{
		...
		{Name: "config_data", Type: field.TypeJSON, SchemaType: map[string]string{"mysql": "json", "postgres": "jsonb"}},
